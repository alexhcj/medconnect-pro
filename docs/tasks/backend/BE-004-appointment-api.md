...
- PR:
- Notes: No `read:appointments` catalog string; reads use `write:appointments`, `read:assigned_patients`, or `read:own_patient`. Audit HTTP list is [SEC-003](../security/SEC-003-audit-event-model.md). Waitlist, reminders, and frontend wiring stay out of scope.
